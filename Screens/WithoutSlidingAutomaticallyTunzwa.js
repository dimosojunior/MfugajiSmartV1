...
//----------------------USING AN ARROW------------------
  ...
  //     const nextIndex = (activeIndex + 1) % queryset2.length;
  ...
  // const goBack = () => {
  //   if (flatlistRef.current) {
  //     const prevIndex = (activeIndex - 1 + queryset2.length) % queryset2.length;
  //     flatlistRef.current.scrollToIndex({ index: prevIndex });
  //     setActiveIndex(prevIndex);
  //   }
  // };

//----------------------MWISHO USING AN ARROW------------------
...
{ !isLoading2 ? (
  <>
      ...
      <>
        ...
        {activeIndex < queryset2.length - 1 && (
