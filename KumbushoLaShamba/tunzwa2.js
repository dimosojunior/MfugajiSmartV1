        ...
        borderRadius:10,
          ...
          <Picker
           style={[globalStyles.pickerInputAddNewProject,
            ...
            selectedValue={selectedUmriWaKuku}
            onValueChange={(itemValue) => setSelectedUmriWaKuku(itemValue)}
          >

            {UmriWaKuku.map((x) => (
              <Picker.Item
                key={x.id}
                label={"Wiki:" + " " + x.UmriKwaWiki + "," + " " + "Siku" + " " + x.Interval}
                value={x}
                color="green"
              />
            ))}
...
<Text style={styles.ButtonTextUpdate2}>Kusanya</Text>
</TouchableOpacity>
    ...
    <View style={{ marginTop: 20 }}>
      <View style={{ width: '90%', marginHorizontal: 20 }}>
        <Text style={[globalStyles.haippo, { color: 'wheat' }]}>
          Chagua aina za chanjo ulizobakisha
        </Text>
      </View>
