...
export default function AinaYaKuku_MabadilikoYaLishe ({navigation, route}) {
...
const getItems = () => {
  if (endReached) {
   ...
   const url = EndPoint + `/GetAinaZaKukuView/?page=${current_page}&page_size=8`
    // console.log(url);
    fetch(url)
      .then((res) => res.json())
      .then((data) => {
      ...
      <CustomCard >
              ...
              {item.PichaYaKuku ? ( 
                  ...
                  style={globalStyles.AppItemButtonHomeScreenOtherPages}
                   ...
                   onPress={() =>
                    navigation.navigate('Umri Wa Kuku MabadilikoYaLishe', {...item, JinaLaHuduma})}
                   >
                    <Text 
...
<MinorHeader title="Aina Ya Kuku" />
    ...
    <View style={globalStyles.searchbarOtherPages}>
                 ...
                 <View style={globalStyles.searchbarIconContainerOtherPages}>
                    ...
                    placeholder="Tafuta aina ya kuku" 
