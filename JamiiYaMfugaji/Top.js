...
export default function Top({item,userToken,setUserToken, userData,setUserData, isLoading,setIsLoading}) {
              ...
              >
                <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0, 0, 0, 0.2)' }}>
                  <View style={globalStyles.ModalView}>
                    <Text style={{ marginLeft: 90, fontFamily:'Light', }}>Hello {item ? item.username : ''}</Text>
