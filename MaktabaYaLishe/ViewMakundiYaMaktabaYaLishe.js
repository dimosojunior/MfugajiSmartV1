...
import { StyleSheet,Platform,TextInput,ActivityIndicator,
  ...
  TouchableWithoutFeedback, Keyboard,Dimensions,Linking,Alert,
...
export default function ViewMakundiYaMaktabaYaLishe({navigation, route}) {
...
const downloadFromAPI = async () => {
 ...
 {!isPending ? (
      ...
      <MinorHeader title="Maktaba Ya Lishe" />
